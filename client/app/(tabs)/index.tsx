      ...
      <ScrollView className="flex-1 px-4" showsVerticalScrollIndicator={false}>
        ...
        <View className="mb-6">
          <View className="flex-row justify-between items-center mb-4">
            <Text className="text-xl font-bold text-primary">Catagories</Text>
          </View>
          ...
          {loading ? (
            ...
            <View className="flex-row flex-wrap justify-between">
              {products.slice(0, 4).map((product) => (
                // <Text key={products._id}>{products.name}</Text>
        ...
        <View className="bg-gray-100 p-6 rounded-2xl mb-20 items-center">
          ...
          <Text className="text-secondary text-center mb-4">
            Subscibe to our newsletter and get 10% off your first purchase.
          </Text>
